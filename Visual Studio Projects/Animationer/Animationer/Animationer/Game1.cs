...
namespace Animationer
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            mSprite.LoadContent(this.Content, "Explosion");
            mSpriteTwo.LoadContent(this.Content, "Explosion");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            mSprite.Draw(this.spriteBatch, tid);
            mSpriteTwo.Draw(this.spriteBatch, tid);
