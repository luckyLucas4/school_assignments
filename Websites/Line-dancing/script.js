...
Player.prototype.Draw = function () {
    ...
    if(this.onGround){
        if ((this.y > 0 || this.y - this.yVel > 0) && this.jumping && this.onGround) {
            this.y = 0;
            this.jumping = false;
            this.yVel = 0;
        }
...
Player.prototype.CheckCollision = function (object) {
    ...
    //Check if player is off platform
    if (this.y >= 0 && this.x < totalWidth / 7 || this.x > totalWidth * 6 / 7) {
        this.onGround = false;
        this.bouncing = true;
    }
    ...
    if (this.x <= 0) {
        this.bouncing = true;
        this.flyDir = totalWidth * gravity / 2500;
        this.yVel = 0;
    }
